...
using SteelManagement.AutoUpdate.DBUtility;//Please add references
using SteelManagement.AutoUpdate;
namespace SteelManagement.AutoUpdate.DAL
{
	/// <summary>
	/// 数据访问类:ProgramUpdate
	/// </summary>
	public partial class ProgramUpdateDal
	{
		...
		public SteelManagement.AutoUpdate.Model.ProgramUpdateModel GetModel(int Id)
		{
			...
			SteelManagement.AutoUpdate.Model.ProgramUpdateModel model=new SteelManagement.AutoUpdate.Model.ProgramUpdateModel();
		...
		/// 得到一个对象实体
		/// </summary>
		public SteelManagement.AutoUpdate.Model.ProgramUpdateModel DataRowToModel(DataRow row)
		{
			SteelManagement.AutoUpdate.Model.ProgramUpdateModel model =new SteelManagement.AutoUpdate.Model.ProgramUpdateModel();
			if (row != null)
			{
