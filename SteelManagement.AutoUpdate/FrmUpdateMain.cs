...
using SteelManagement.AutoUpdate.BLL;
using SteelManagement.AutoUpdate.Common;
using SteelManagement.AutoUpdate.DBUtility;
...
namespace SteelManagement.AutoUpdate
{
    ...
    font);
        ...
        {
            Process.Start(GlobalUtils.AppPath + "\\SteelManagement.CSUI.exe");
            Application.Exit();
        }
