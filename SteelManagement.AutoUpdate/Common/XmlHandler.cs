...
namespace SteelManagement.AutoUpdate.Common
{
    public static class XmlHandler
    {
        public static string GetPropramVersion()
        {
            ...
            try
            {
                string configpath = GlobalUtils.AppPath + "\\" + "SteelManagement.CSUI.exe.config";
            ...
            try
            {
                ...
                foreach (XElement xElement in settings.Elements())
                {
                    if (xElement.Attribute("key").Value == "Version")
                    {
                        ...
                        xDoc.Save(GlobalUtils.AppPath + "\\" + "SteelManagement.CSUI.exe.config");
                        return true;
                    }
                }
                return false;
