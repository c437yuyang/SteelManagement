...
namespace SteelManagement.DAL
{
	...
	public partial class ProgramUpdate
	{
		...
		public SteelManagement.Model.ProgramUpdate GetModel(int Id)
		{
			...
			SteelManagement.Model.ProgramUpdate model=new SteelManagement.Model.ProgramUpdate();
		...
		/// 得到一个对象实体
		/// </summary>
		public SteelManagement.Model.ProgramUpdate DataRowToModel(DataRow row)
		{
			SteelManagement.Model.ProgramUpdate model=new SteelManagement.Model.ProgramUpdate();
			if (row != null)
			{
