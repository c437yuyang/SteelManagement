...
namespace SteelManagement.DAL
{
	...
	public partial class ActionRecords
	{
		...
		public int Add(SteelManagement.Model.ActionRecords model)
		{
			...
			strSql.Append("EntryTime,UserId,ActType,ActId)");
			...
			parameters[2].Value = model.ActType;
			parameters[3].Value = model.ActId;
		...
		public SteelManagement.Model.ActionRecords GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,EntryTime,UserId,ActType,ActId from ActionRecords ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			SteelManagement.Model.ActionRecords model=new SteelManagement.Model.ActionRecords();
		...
		/// 得到一个对象实体
		/// </summary>
		public SteelManagement.Model.ActionRecords DataRowToModel(DataRow row)
		{
			SteelManagement.Model.ActionRecords model=new SteelManagement.Model.ActionRecords();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,EntryTime,UserId,ActType,ActId ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,EntryTime,UserId,ActType,ActId ");
			strSql.Append(" FROM ActionRecords ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
