...
namespace SteelManagement.Common.Excel
{
    ...
    public static class ExcelGenerator
    {
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static bool GetPurchaseInfoReport(List<Model.PurchaseInfo> list)
        {
            //1.创建工作簿对象
            IWorkbook wkbook = new HSSFWorkbook();
            //2.创建工作表对象
            ...
            row.CreateCell(5).SetCellValue("运输方式");
            row.CreateCell(6).SetCellValue("规格");
            row.CreateCell(7).SetCellValue("材质");
            row.CreateCell(8).SetCellValue("送货量");
            row.CreateCell(9).SetCellValue("报价");
            row.CreateCell(10).SetCellValue("浮动");
            row.CreateCell(11).SetCellValue("运费");
            row.CreateCell(12).SetCellValue("吊装");
            row.CreateCell(13).SetCellValue("利息");
            row.CreateCell(14).SetCellValue("承兑");
            row.CreateCell(15).SetCellValue("其他成本");
            row.CreateCell(16).SetCellValue("贴息");
            row.CreateCell(17).SetCellValue("单价");
            row.CreateCell(18).SetCellValue("总金额");
            ...
            sheet.SetColumnWidth(20, 10 * 256);//收款
            //sheet.SetColumnWidth(21, 10 * 256);//收款
            //sheet.SetColumnWidth(22, 10 * 256);//收款
            ...
            for (int i = 0; i != list.Count; ++i)
            {
                ...
                row.CreateCell(0).SetCellValue(list[i].Corporation);
                row.CreateCell(1).SetCellValue(list[i].Project);
                row.CreateCell(2).SetCellValue(DateTimeFormator.DateTimeToString(list[i].Dateline));
                row.CreateCell(3).SetCellValue(list[i].Supplier);
                row.CreateCell(4).SetCellValue(list[i].Brand);
                row.CreateCell(5).SetCellValue(list[i].TransportWay);
                row.CreateCell(6).SetCellValue(list[i].Size);
                row.CreateCell(7).SetCellValue(list[i].Texture);
                row.CreateCell(8).SetCellValue(DecimalHandler.DecimalToString(list[i].Amount, digit));
                row.CreateCell(9).SetCellValue(DecimalHandler.DecimalToString(list[i].Quote, digit));
                row.CreateCell(10).SetCellValue(DecimalHandler.DecimalToString(list[i].Fluctuation1, digit));
                row.CreateCell(11).SetCellValue(DecimalHandler.DecimalToString(list[i].TransportCost, digit));
                row.CreateCell(12).SetCellValue(DecimalHandler.DecimalToString(list[i].DiaoZhuang, digit));
                row.CreateCell(13).SetCellValue(DecimalHandler.DecimalToString(list[i].LiXi, digit));
                row.CreateCell(14).SetCellValue(DecimalHandler.DecimalToString(list[i].ChengDui, digit));
                row.CreateCell(15).SetCellValue(DecimalHandler.DecimalToString(list[i].OtherCost, digit));
                row.CreateCell(16).SetCellValue(DecimalHandler.DecimalToString(list[i].TieXi, digit));
                row.CreateCell(17).SetCellValue(DecimalHandler.DecimalToString(list[i].Price, digit));
                row.CreateCell(18).SetCellValue(DecimalHandler.DecimalToString(list[i].TotalMoney, digit));
                //row.CreateCell(19).SetCellValue(DateTimeFormator.DateTimeToString(list[i].FuYuDate));
                //row.CreateCell(20).SetCellValue(DecimalHandler.DecimalToString(list[i].Money1, digit));
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        public static bool GetPurchaseBillReport(List<Model.PurchaseBill> list)
        {
            //1.创建工作簿对象
            IWorkbook wkbook = new HSSFWorkbook();
            //2.创建工作表对象
            ISheet sheet = wkbook.CreateSheet("采购款项");
            ...
            row.CreateCell(4).SetCellValue("付款人");
            ...
            for (int i = 0; i != list.Count; ++i)
            {
                ...
                row.CreateCell(4).SetCellValue(list[i].Payer);
            ...
            //sheet.AddMergedRegion(new CellRangeAddress(1, sheet.LastRowNum, 13, 13));
            //5.执行写入磁盘
            string dstName = GlobalUtils.ShowSaveFileDlg("采购款项.xls", "office 2003 excel|*.xls");
            return SaveFile(dstName, wkbook);
        }
