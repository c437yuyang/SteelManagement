...
{
    public partial class FrmReceiptInfoManage : Form
    {
        private readonly SteelManagement.BLL.ReceiptInfo _bllReceiptInfo = new SteelManagement.BLL.ReceiptInfo();
        ...
        {
            _recordCount = _bllReceiptInfo.GetRecordCount(_where);
        ...
        public void LoadDataToDataGridView(int page) //刷新后保持选中
        {
            ...
            dataGridView1.DataSource = _bllReceiptInfo.GetListByPageOrderById(_where, _curPage, _pageSize);
        ...
        private void btnAddFromExcel_Click(object sender, EventArgs e)
        {
            ...
            //    return;
            //int res = _bllReceiptInfo.AddList(list);
        ...
        private List<Model.ReceiptInfo> DgvDataSourceToList()
        {
            return dataGridView1.DataSource as List<Model.ReceiptInfo>;
        }
        ...
        /// </summary>
        /// <returns></returns>
        private List<Model.ReceiptInfo> GetSelectedModelList()
        {
            var visaList = dataGridView1.DataSource as List<Model.ReceiptInfo>;
            List<Model.ReceiptInfo> res = new List<ReceiptInfo>();
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int res = _bllReceiptInfo.DeleteList(modelList);
        ...
        //        return;
        //    }
        //    //FrmAddReceiptInfo frm = new FrmAddReceiptInfo(LoadDataToDataGridView, _curPage, list[0]);
        //    //frm.ShowDialog();
        //}
        #endregion
